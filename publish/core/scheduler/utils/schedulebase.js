                    ...
                    if (scheduleStatus == 1) {
                        return SchedulePost.findById(mongoScheduleId)
                            .then((mongoDetails) => {
                                ...
                                var postingSocialIds = mongoDetails.postingSocialIds;
                            ...
                            .catch(() => {
                                logger.info(`unable to fetch the mongo database..`);
                            });
                    }
                }
            })
    ...
    cancelSchedule(scheduleId) {
        ...
        return new Promise((resolve, reject) => {
            return scheduledInformations.findOne({
                ...
                .then((result) => {
                    if (!result)
                        throw new Error("unable to find the schedule Information");
                    else {
