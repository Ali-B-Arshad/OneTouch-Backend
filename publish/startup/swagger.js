...
class Swagger {
    ...
    constructor(app, rootDir) {
        ...
        var swaggerDefinition = {
            info: {
                title: config.get('publisher_OneTouch.title'),
                version: config.get('publisher_OneTouch.version'),
                description: config.get('publisher_OneTouch.description'),
            },
            host: `${config.get('publisher_OneTouch.host')}`,
            basePath: '/',
            securityDefinitions: {
                AccessToken: {
                    type: 'apiKey',
