                ...
                return db.sequelize.transaction((t) => {
                    return teamInfo.findOne({
                        ...
                        .then((teamInfo) => {
                            ...
                            // Validating the inviting user belongs to the OneTouch or not
                            return userDetails.findOne({
                ...
                return teamInfo.findOne({
                    ...
                    .then((teamInfo) => {
                        if (teamInfo == null)
                            ...
                            // Checking the invited user is belongs to the OneTouch or not
                            return userDetails.findOne({
                                where: { email: emailId },
                                attributes: ['user_id']
                            }, { transaction: t });
                    ...
                    .then((users) => {
                        ...
                        return Promise.all(users.map(user => {
                            return userDetails.findOne({
                                ...
                                attributes: ['user_id', 'email', 'first_name', 'last_name', 'date_of_birth', 'profile_picture'],
                            })
                                .then((matchUser) => {
                                    if (matchUser) {
            ...
            return db.sequelize.transaction((t) => {
                return socialAccount.count({
                    ...
                    .then((availableCount) => {
                        ...
                        console.log(`Available Account Count : ${availableCount}`);
                        if (availableCount == 0) {
                            ...
                            return socialAccount.findOne({
                                ...
                                .then((socialAcc) => {
                                    if (socialAcc == null)
                                        ...
                                        throw new Error("You can't delete this account. As this is your primary account, which you used to login to OneTouch.");
                                    }
                                    else {
