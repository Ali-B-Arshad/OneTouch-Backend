...
PayUMoney.prototype.makePayment = function (data, callback) {
    ...
    var postData = `key=${this.credentails.key}&txnid=${data.txnid}&amount=${data.amount}&productinfo=${data.productinfo}&firstname=${data.firstname}&lastname=&email=${data.email}&udf1=${data.udf1}&udf2=${data.udf2}&surl=${data.surl}&furl=${data.furl}&hash=${hash}&service_provider=${this.credentails.service_provider}`;
