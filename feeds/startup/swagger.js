...
class Swagger {
    ...
    constructor(app, rootDir) {
        ...
        var swaggerDefinition = {
            info: {
                title: config.get('feed_OneTouch.title'),
                version: config.get('feed_OneTouch.version'),
                description: config.get('feed_OneTouch.description'),
            },
            host: `${config.get('feed_OneTouch.host')}`,
            basePath: '/',
            securityDefinitions: {
                AccessToken: {
                    type: 'apiKey',
