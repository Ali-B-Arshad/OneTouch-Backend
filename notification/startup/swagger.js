...
class Swagger {
    constructor(app, rootDir) {
        var swaggerDefinition = {
            info: {
                title: config.get('notification_OneTouch.title'),
                version: config.get('notification_OneTouch.version'),
                description: config.get('notification_OneTouch.description'),
            },
            host: `${config.get('notification_OneTouch.host')}`,
            basePath: '/',
            securityDefinitions: {
                AccessToken: {
                    type: 'apiKey',
